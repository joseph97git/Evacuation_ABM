...
public class LayoutWallTest extends JPanel implements ActionListener {
     ...
     *            standing in the doorway looking in.
     */
    public LayoutWallTest(int width, int depth) {
        this.width = width;
        this.depth = depth;
        this.timer = new Timer(5, this);
        agents = new Agent[6];
        walls = new Obstacle[16];
